...
import ArticleListNoSmart from "../../components/article-list-no-smart";
...
export default function DumbArticlesListTemplate({
  articles,
  totalCount,
  cursor,
  site,
  ...
  return (
    <Layout>
      <NextSeo title="Articles (No Smart Crop)" description="Articles without smart cropping" />

      <ArticleListNoSmart
        headerText="Articles (No Smart Crop)"
        articles={articles}
        cursor={cursor}
